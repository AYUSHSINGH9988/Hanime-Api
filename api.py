...
# 🔥 NEW FASTAPI LIFESPAN SYSTEM (Fixes the Deprecation Warning)
@asynccontextmanager
...
app = FastAPI(title="AyuPrime Extractor API", lifespan=lifespan)
...
if __name__ == "__main__":
    # 🔥 FIXED: Passed "api:app" as a string to resolve the Uvicorn warning
